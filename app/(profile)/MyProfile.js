...
import { Text, View, ScrollView, StyleSheet, Platform, TouchableOpacity, Modal } from "react-native";
    ...
    <View className="flex-1 bg-gray-50">
      <ScrollView className="flex-1">
        <View className="p-6 pt-16">
          {/* Header */}
          <View className="mb-6">
            <Title className="text-4xl font-bold text-gray-900 mb-2">My Profile</Title>
            <Title className="text-base text-gray-600">Manage your account and preferences</Title>
          </View>
              ...
              <CardContent>
                ...
                >
                  <View className="flex-row items-center">
                    ...
                    <View>
                      <Title className="text-base font-semibold text-gray-900">My Orders</Title>
                      <Title className="text-sm text-gray-600">
                        {data && !isLoading ? `${data} orders` : "No orders yet"}
                      </Title>
                    </View>
                  </View>
              ...
              <CardContent>
                ...
                >
                  <View className="flex-row items-center">
                    ...
                    <View>
                      <Title className="text-base font-semibold text-gray-900">My Listed Items</Title>
                      <Title className="text-sm text-gray-600">
                        {data && !isLoading ? `${data} items` : "No items listed"}
                      </Title>
                    </View>
                  </View>
                  <Feather name="chevron-right" size={20} color="#9ca3af" />
              ...
              <CardContent>
                ...
                >
                  <View className="flex-row items-center">
                    ...
                    <View>
                      <Title className="text-base font-semibold text-gray-900">My Listed Orders</Title>
                      <Title className="text-sm text-gray-600">
                        {data && !isLoading ? `${data} orders` : "No orders yet"}
                      </Title>
                    </View>
              ...
              <CardContent>
                ...
                >
                  <View className="flex-row items-center">
                    ...
                    <View>
                      <Title className="text-base font-semibold text-gray-900">Settings</Title>
                      <Title className="text-sm text-gray-600">Notifications, password</Title>
                    </View>
                  </View>
                  <Feather name="chevron-right" size={20} color="#9ca3af" />
                </TouchableOpacity>
