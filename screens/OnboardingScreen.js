...
const ONBOARDING_DATA = [
  {
    ...
    description: 'Discover exclusive deals and a seamless shopping experience at your fingertips.',
    image: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?q=80&w=2070&auto=format&fit=crop',
  },
  {
    title: 'Sell with Ease, Earn More',
    description: 'List your items in seconds and connect with buyers effortlessly.',
    image: 'https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?q=80&w=2070&auto=format&fit=crop',
  },
  {
    title: 'Join the Marketplace Revolution',
    description: 'A trusted platform where buyers and sellers meet for a smooth transaction.',
...
export default function OnboardingScreen({ onFinish }) {
  ...
  const onPrevious = () => {
    if (currentIndex > 0) {
      ...
      scrollViewRef.current.scrollTo({ x: SCREEN_WIDTH * prevIndex, animated: true });
    }
  };
