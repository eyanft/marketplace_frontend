...
const product = {
  ...
  description:
    "Chaussures de sport légères et confortables parfaites pour la course.",
  price: 99.99,
  rating: 4.5,
  images: [
...
const similarProducts = [
  {
    ...
    price: 89.99,
    image:
      "https://images.unsplash.com/photo-1580316014900-3c0a5a3e5f1d?auto=format&fit=crop&w=800&q=80",
  },
  {
    id: 3,
    name: "Puma Sprint",
    price: 79.99,
    image:
      "https://images.unsplash.com/photo-1618354691267-b709c389d161?auto=format&fit=crop&w=800&q=80",
  },
];
...
const ProductDetailsScreen = () => {
  ...
  return (
    <ScrollView style={{ padding: 16 }}>
      ...
      <TouchableOpacity onPress={() => router.navigate("/ratingReviews")}>
